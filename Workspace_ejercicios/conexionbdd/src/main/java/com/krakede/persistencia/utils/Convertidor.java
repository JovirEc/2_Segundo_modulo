...
public class Convertidor {
	...
	public static Date convertirFecha(String fechaStr) throws Exception {
		...
		Date fechaDate = null;
		try {
			LOGGER.trace("Conviritiendo fecha"+fechaStr);
	...
	public static Date convertirHora(String horaStr) throws Exception {
		...
		try {
			...
			LOGGER.error("La hora tiene no tiene el formato correcto"+horaStr,e);
			throw new Exception("La hora tiene no tiene el formato correcto"+horaStr);
		}
		return horaDate;
	}
}
